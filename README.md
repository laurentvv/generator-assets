...
* **Process**:
  ...
  2. **AI engine (default, validated 2026-09-09)**: Stable Audio 3 Small SFX via audio.cpp (Vulkan, RTF ~0.2 — fastest audio engine on this machine), 44.1 kHz stereo. Level treatment: transient SFX are peak-normalized to −0.9 dBFS; low-loudness "texture" outputs (rain…, body < −20 LUFS under an isolated peak) get the peak limited then the body raised to −16 LUFS (linear loudnorm).
