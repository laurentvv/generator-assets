...
* **Piste suivante (idée utilisateur, non testée) : « dubbing » vocal sur l'instrumental** — poser une voix générée (ex. paroles de nos chansons lues par la voix clonée `voix_off`) sur `llb_instrumental.mp3`, éventuellement **calée sur les moments de la voix d'origine**. Cartographie établie depuis `vocals.wav` (silencedetect −32 dB/0,45 s, 2026-09-06) : chant de 14,8→60,9 s • 75,2→77,8 • 78,8→84,1 • 84,6→89,8 • 90,3→121,9 • 177,1→180,8 • 181,4→243,8 (≈157 s de chant sur 247 s ; break instrumental 122→177 s). Pipeline : segments → voix_off par segment (durée ajustée par atempo) → adelay/amix sur l'instrumental + ducking.
