...
* **Artéfacts d'écoute** : `output/musicgen_test/` (`mgl_text2music_10s.wav`, `mgl_melodie_12s.wav` + paires A/B). Script de test : `C:\temp\mgt\test_musicgen.py` (jetable). Nettoyage possible après écoute : modèle 9,8 Gio + venv, disque C: à 96 %.
